<template lang="pug">
.wrapper
    Sidebar(element="aside", :items="sidebarItems",:class="{ 'is-active': sidebarActive }")
        h1.logo
    ...
    main#main
        .hub
            ...
            a.mobile-trigger(v-on:click="sidebarActive != sidebarActive",:class="{ 'is-active': sidebarActive }")
                span
        .content
            Content
